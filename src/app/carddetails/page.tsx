            ...
            <div className="sec grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 xl:px-5 ">
              ...
              <Card className="w-full max-w-[330px] mx-auto h-auto flex flex-col justify-between">
                <CardHeader>
                  ...
                  <Image src={"/Catalog 1.png"} alt="car" width={700} height={700} />
              ...
              <Card className="w-full max-w-[330px] mx-auto h-auto flex flex-col justify-between">
                <CardHeader>
                  ...
                  <Image src={"/Catalog 2.png"} alt="car1" width={700} height={700} />
              ...
              <Card className="w-full max-w-[330px] mx-auto h-auto flex flex-col justify-between">
                <CardHeader>
                  ...
                  <Image src={"/Catalog 3.png"} alt="car2" width={700} height={700} />
            ...
            <div className="sec grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 xl:px-5 ">
              ...
              <Card className="w-full max-w-[330px] mx-auto h-auto flex flex-col justify-between">
                <CardHeader>
                  ...
                  <Image src={"/Catalog 1 (2).png"} alt="car3" width={700} height={700} />
              ...
              <Card className="w-full max-w-[330px] mx-auto h-auto flex flex-col justify-between">
                <CardHeader>
                  ...
                  <Image src={"/Catalog 2 (1).png"} alt="car4" width={700} height={700} />
              ...
              <Card className="w-full max-w-[330px] mx-auto h-auto flex flex-col justify-between">
                <CardHeader>
                  ...
                  <Image src={"/Catalog 2 (3).png"} alt="car5" width={700} height={700} />
              ...
              <Card className="w-full max-w-[330px] mx-auto h-auto flex flex-col justify-between">
                <CardHeader>
                  ...
                  <Image src={"/Catalog 2 (1).png"} alt="car5" width={700} height={700} />
